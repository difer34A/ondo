...
export default function Footer() {
  return (
    <div className='w-full flex flex-col gap-10'>
        ...
        <div className='flex place-items-center gap-4 justify-end flex-col sm:flex-row' >
        ...
        <div className='w-full text-slate-300 opacity-80 font-light text-xs grid grid-cols-1 md:grid-cols-4 gap-2'>
            <h1 className='cursor-pointer'>Бүх эрх хуулиар хамгаалагдсан © 2022. ОНДО ХХК</h1>
            <h1 className='cursor-pointer md:flex justify-center'>Мэдээ, мэдээлэл</h1>
            <h1 className='cursor-pointer md:flex justify-center'>Дүрэм, журам</h1>
            <h1 className='cursor-pointer md:flex justify-end'>Үйлчилгээний нөхцөл</h1>
        </div>
        <div/>
    </div>
  )
